...
import com.freedom.common.enums.ResultCode;
...
public class ResultUtils {
    ...
    public static <T> Result<T> buildResult(ResultCode code,String msg){
        return Result.<T>builder().code(code.getCode()).msg(msg).build();
    }
